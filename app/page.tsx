...
// Dummy data for the chart with green theme colors
const expenseData = [
          ...
          <div className="space-y-6">
            ...
            <Card className="shadow-lg bg-gradient-to-br from-green-500 to-emerald-600 text-white border-0">
              <CardContent className="text-center p-8">
                ...
                <p className="text-4xl font-bold mb-2">$4,280.45</p>
            ...
            <Card className="shadow-lg">
              <CardContent className="text-center p-8">
                ...
                <p className="text-4xl font-bold text-destructive mb-2">$2,720</p>
            ...
            <Card className="shadow-lg">
              ...
              <CardContent className="space-y-4 pt-0">
                <Button className="w-full bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white" size="lg">
                  Add Income
                </Button>
